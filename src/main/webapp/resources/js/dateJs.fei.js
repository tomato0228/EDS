...
function setInput(selectDay) {
    document.getElementById('fileLifeCycle').value = checkYear + splitString + checkMonth + splitString + selectDay;
    hidDate();
}
...
function showDate() {
    ...
    //var x = document.getElementById('fileLifeCycle').style.left;
    //var y = document.getElementById('fileLifeCycle').offsetTop  22;
    var x =  $("#fileLifeCycle").offset().left;
    var y =  $("#fileLifeCycle").offset().top - 245;
