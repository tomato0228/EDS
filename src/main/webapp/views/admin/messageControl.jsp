...
<%@ page import="com.njust.eds.service.MessageService" %>
<%@ page import="com.njust.eds.service.UserService" %>
...
<div id="wrap">
    ...
    <div id="rightContent">
        ...
        <div class="tab-content">
            <nav class="Hui-breadcrumb"><i class="icon-home"></i> 首页 <span class="c-gray en">&gt;</span> 消息管理
    ...
    <span class="l"><a href="javascript:;" onClick="datadel()" class="btn btn-danger radius"><i class="icon-trash"></i> 批量删除</a>
                    <span class="r">共有数据：<strong>${Messagelist.size()}</strong> 条</span>
                </div>
