            ...
            *********************************************************************************************************************************************************** -->
                ...
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li class="active"><a href="#" onclick="window.location.href='${ctx}/user/myLog'">我的日志</a></li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> ${sessionScope.loginUser.getUserName()}的日志</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <table class="table table-striped border-top" id="sample_1">
                                        ...
                                        <c:forEach items="${loglist}" var="item" varStatus="loop">
                                            <c:set value="${fn:length(filelist[loop.count-1]) - 36}"
                                                   var="length"></c:set>
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="hidden-phone">
                                                    <c:choose>
                                                        <c:when test="${item.logOptype==1}"><span
                                                                class="label label-success">上  传</span></c:when>
                                                        <c:when test="${item.logOptype==2}"><span
                                                                class="label label-danger">删  除</span></c:when>
                                                        <c:when test="${item.logOptype==3}"><span
                                                                class="label label-info">查  看</span></c:when>
                                                        <c:when test="${item.logOptype==4}"><span
                                                                class="label label-warning">下  载</span></c:when>
                                                        <c:when test="${item.logOptype==5}"><span
                                                                class="label label-primary">修  改</span></c:when>

                                                    </c:choose></td>
                                                <td class="hidden-phone">
                                                    <a class="label label-danger" href="#"
                                                       onclick="Log_del(${item.logId})"><i
