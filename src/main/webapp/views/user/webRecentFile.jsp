            ...
            *********************************************************************************************************************************************************** -->
                ...
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li class="active"><a href="#" onclick="window.location.href='${ctx}/user/webRecentFile'">近期文件</a></li>
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> 近期共享文件</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <c:forEach items="${sessionScope.WebRecentFiles}" var="recentFile" varStatus="loop">
                                <!-- TWITTER PANEL -->
                                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                    <div class="weather-2 pn">
                                        <div class="weather-2-header">
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-6">
                                                    <p class="user">${sessionScope.WebRecentFileUsers[loop.count-1].userName}</p>
                                                </div>
                                        ...
                                        <div class="row centered">
                                            <img src="${ctx}/resources/img/prefix/${recentFile.fileType}.png"
                                        ...
                                        <div class="row centered" style="font-size: 1.2em">
                                            <c:choose>
                                                <c:when test="${fn:length(recentFile.fileName) <= 25}">
                                                    <p class="user">${recentFile.fileName}</p>
                                                </c:when>
                                                <c:otherwise>
                                                    <p class="user">${fn:substring(recentFile.fileName, 0, 25)}...</p>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </div>
