...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="${ctx}/resources/aboutUser/css/style.css">
</head>
<body>
<c:choose>
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="#"  onclick="window.location.href='${ctx}/user/EDSUser'">作者介绍</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-11">
                                        <div class="wrapper1">
                                            <div id="steps" class="steps" style="font-size: 2.5em;margin-top: 50px">
                                                <div id="step-1" class="step-content"><img src="${ctx}/resources/aboutUser/img/1.png" onerror="this.onerror=null; this.src='img/1.png'" class="steps__icon">
                                                    <div class="steps__description"><span style="margin-left: 80px">我是王余阳<br></span><span style="margin-left: 85px">我是软工2班的</span>
                                                    </div>
                                                </div>
                                                <div id="step-2" class="step-content"><img src="${ctx}/resources/aboutUser/img/2.png" onerror="this.onerror=null; this.src='img/2.png'" class="steps__icon">
                                                    <div class="steps__description"><span style="margin-left: 80px">我是魏煜华<br></span><span style="margin-left: 85px">我是计科1班的</span>
                                                    </div>
                                                </div>
                                                <div id="step-3" class="step-content"><img src="${ctx}/resources/aboutUser/img/3.png" onerror="this.onerror=null; this.src='img/3.png'" class="steps__icon">
                                                    <div class="steps__description"><span style="margin-left: 80px">我是石杨<br></span><span style="margin-left: 85px">我是网工1班的</span>
                                                    </div>
                                                </div>
                                                <div id="step-4" class="step-content"><img src="${ctx}/resources/aboutUser/img/4.png" onerror="this.onerror=null; this.src='img/4.png'" class="steps__icon">
                                                    <div class="steps__description"><span>我负责的是</span>后台平台搭建，业务层的便携式，逻辑层的编写，主要是User.
                                                    </div>
                                                </div>
                                                <div id="step-5" class="step-content"><img src="${ctx}/resources/aboutUser/img/5.png" onerror="this.onerror=null; this.src='img/5.png'" class="steps__icon">
                                                    <div class="steps__description"><span>我负责的是</span>后台平台搭建，业务层的便携式，逻辑层的编写，主要是Admin，后转User.
                                                    </div>
                                                </div>
                                                <div id="step-6" class="step-content"><img src="${ctx}/resources/aboutUser/img/6.png" onerror="this.onerror=null; this.src='img/6.png'" class="steps__icon">
                                                    <div class="steps__description"><span>我负责的是</span>后台平台搭建，前端原型的编写和前端框架的编写.
                                                    </div>
                                                </div>
...
<script src="${ctx}/resources/aboutUser/js/index.js"></script>
